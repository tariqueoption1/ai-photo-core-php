                  ...
                  <div class="col-md-12 mx-auto">
                     ...
                     <div class="element-border" id="element-border">
                        ...
                        <div class="d-flex justify-content-center language">
                           <button id="startCameraButtonEnglish" class="btn start-camera-button" style="font-family:BlissPro;font-weight: bold;">Press to Start</button>
                        </div>
...
<script>
   document.addEventListener('DOMContentLoaded', function () {
     ...
     document.querySelectorAll('button').forEach(button => {
         button.style.fontFamily = 'BlissPro';
     });
   } else if (language === 'ar') {
     document.querySelectorAll('button').forEach(button => {
